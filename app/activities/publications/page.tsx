    ...
    <SiteShell active="activities">
      ...
      <section className="py-16 sm:py-20 bg-[#0d2b1e]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <BookOpen className="h-9 w-9 text-amber-400" aria-hidden="true" />
            Publications
          </h1>
          <div className="w-12 h-1 bg-amber-500 mb-6 rounded-full" />
          <p className="text-lg text-white/75 max-w-3xl">
            ARANYA publications share research insights, project learnings, and practical guides to support climate
