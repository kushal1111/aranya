...
const description =
  "Explore ARANYA Initiatives projects, publications and events supporting advocacy, research, action and community work."
    ...
    <SiteShell active="activities">
      ...
      <section className="py-16 sm:py-20 bg-[#0B3D35]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-[#D8A84E] mb-3">What We Do</p>
          ...
          <p className="text-lg text-white/75 max-w-3xl">
            Discover how {ORG_SHORT} creates impact through projects, publications, and events.
          </p>
        </div>
      </section>
          ...
          {activities.map((activity) => {
            ...
            return (
              <Link key={activity.href} href={activity.href} className="group">
                <Card className="h-full border border-gray-200 hover:border-[#2F80A8] hover:shadow-md transition-all duration-200">
                  <CardContent className="p-6">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#0B3D35] transition-colors">
                      {activity.title}
                    </h2>
