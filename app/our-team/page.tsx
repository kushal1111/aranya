    ...
    <SiteShell>
      ...
      <section className="py-16 sm:py-20 bg-[#0B3D35]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-[#D8A84E] mb-3">Contact</p>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 inline-flex items-center gap-3">
            <Users className="h-9 w-9 text-[#D8A84E]" aria-hidden="true" />
            Our Team
          </h1>
          <div className="w-12 h-1 bg-[#D8A84E] mb-6 rounded-full" />
          <p className="text-lg text-white/75 max-w-4xl">
            Named team profiles are not published on this website yet. Contact {ORG_NAME} for current staff and
      ...
      <section className="py-16 sm:py-20 bg-[#F1F6F7]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border border-gray-200 shadow-sm">
            <CardHeader>
              <h2 className="text-2xl text-gray-900">Profiles forthcoming</h2>
            </CardHeader>
            <CardContent className="text-sm text-gray-600 leading-relaxed space-y-3">
              <p>
                This page will list people working with {ORG_SHORT} once names, roles, and biographies are confirmed
                for public use.
              </p>
              <p>
                Email{" "}
                ...
                or visit the{" "}
                <Link href="/contact" className="text-[#0B3D35] font-semibold hover:text-[#164f45]">
                  contact page
                </Link>
                .
              </p>
