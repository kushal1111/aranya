      ...
      <section className="py-16 sm:py-20 bg-[#0d2b1e]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-white/75 max-w-3xl">
            Use the details below to reach ARANYA Initiatives. There is no contact form on this website.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-gray-700">
          ...
          <div>
            ...
            <address className="not-italic inline-flex items-start gap-2">
              <MapPin className="h-4 w-4 text-emerald-700 mt-1" aria-hidden="true" />
              {ORG_ADDRESS_LINE}
            </address>
          </div>
          <p>
            For volunteering, see the{" "}
            <Link href="/volunteer" className="text-emerald-700 font-semibold hover:text-emerald-900">
              volunteer page
            </Link>
            .
          </p>
